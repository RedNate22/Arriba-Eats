...
/// <summary>
/// Represents the menu where a client can view all the currently ordered orders (ready to cook),
/// and choose to start cooking them.
/// </summary>
public class ClientStartCookingMenu : IMenu
{
    /// <summary>
    /// Displays a prompt to the client, informing them that the customer order has been marked as cooking.
    /// </summary>
    ...
    /// The client can then choose an order, which marks it as 'cooking', and is then
